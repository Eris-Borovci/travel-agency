            ...
            <form action="{{ route('register') }}" method="POST" class="p-0">
                ...
                <div class="mt-5 block md:grid md:grid-cols-2 md:gap-4">
                    <input name="name" value="{{ old('name') }}" type="text"
                        class="block md:col-auto p-2 w-full border rounded border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-transparent "
                        placeholder="First name">
                    <input name="lastname" value="{{ old('lastname') }}" type="text"
                        class="mt-5 md:col-auto md:mt-0 w-full block p-2 border rounded border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-transparent "
                ...
                <div class="mt-10">
                    <input type="submit" value="Sign up with email"
                        class="py-3 bg-blue-600 text-white w-full rounded hover:bg-blue-500">
                </div>
            </form>
