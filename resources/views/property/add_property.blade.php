                    ...
                    <div class="max-w-xl mx-auto">
                        ...
                        <div class="bg-white py-5 px-8 mt-8 rounded">
                            ...
                            <div class="autocomplete h-full w-full p-1 relative">
                                ...
                                <input id="myInput" type="text" x-model="location" name="myCountry"
                                    placeholder="Location" @input="validateLocation()"
                                    class="w-full p-2.5 pl-10 rounded-sm h-full border border-gray-300 focus:ring-blue-500 focus:border-blue-500">
                            </div>
                        </div>
                        <x-divider />
                        <button :disabled="currentLocation == null"
                            :class="currentLocation == null ? 'bg-gray-500' : ''"
                            class="bg-blue-800 text-white w-full px-2 py-3 rounded" @click="nextSlide">Continue</button>
                    </div>
                </div>
            </div>
        </div>
...
<script type="" src="{{ asset('js/autocomplete.js') }}"></script>
@endsection