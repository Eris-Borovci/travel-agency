                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide px-1 md:px-3">
                        <div class="max-w-xl mx-auto">
                            ...
                            <div class="bg-white py-5 px-8 mt-8 rounded">
                                <div>
                                    <label for="photos"
                                        ...
                                        least one
                                        photo and select the main one</label>
                                    <div class="my-3 filesGroup grid grid-cols-2 gap-3">
                                        <div class="flex justify-center items-center w-full h-48 transition-all"
                                            id="the-drop-zone">
                                            <label for="dropzone-file"
                                                class="flex flex-col justify-center items-center w-full h-48 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer hover:bg-gray-100">
                                                <div class="flex flex-col justify-center items-center pt-5 pb-6">
                                                    ...
                                                    <p class="text-xs text-gray-500 dark:text-gray-400 text-center">Main
                                                        Photo which
                                                        will be used as a profile picture</p>
                                                </div>
                            ...
                            <x-divider />
                            <button :disabled="!areFilesValid" :class="!areFilesValid && '!bg-gray-500'"
                                class="bg-blue-800 text-white w-full px-2 py-3 rounded"
                                @click="nextSlide()">Continue</button>
                        </div>
                    </div>
